...
* | LShf |   Z  |   X  |  C   |  V   |  B   |  N   |  M   |  ,   |   .  |  /   |  ]   |
* |------+------+------+------+------+------+------+------+------+------+------+------|
* | CTR  | ALT  | GUI  |Lower | Raise|Enter | Spce | Spce | Left | Down |  Up  | Rght |
* `-----------------------------------------------------------------------------------'
*/
    [_QWERTY] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, LOWER, RAISE, KC_ENT, KC_SPC, KC_SPC, KC_LEFT, KC_UP, KC_DOWN, KC_RGHT),
...
*/
    [_COLEMAK] = LAYOUT(
        ...
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_K, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RBRC,
        KC_LCTL, KC_LGUI, KC_LALT, LOWER, RAISE, KC_ENT, KC_SPC, KC_SPC, KC_LEFT, KC_UP, KC_DOWN, KC_RGHT),
...
*/
    [_DVORAK] = LAYOUT(
        ...
        KC_LSFT, KC_SCLN, KC_Q, KC_J, KC_K, KC_X, KC_B, KC_M, KC_W, KC_V, KC_Z, KC_RBRC,
        KC_LCTL, KC_LGUI, KC_LALT, LOWER, RAISE, KC_ENT, KC_SPC, KC_SPC, KC_LEFT, KC_UP, KC_DOWN, KC_RGHT),
    ...
    */
    ...
    [_LOWER] = LAYOUT(
        ...
        _______, KC_LGUI, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______),

    /* Raise
* ,-----------------------------------------------------------------------------------.
* |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |
* |------+------+------+------+------+------+------+------+------+------+------+------|
* |      |      |      |      |      |      |      |PageUp|Vol Up|Vol Dn| Play |      |
* |------+------+------+------+------+-------------+------+------+------+------+------|
* |      |      |      |      |      |      |      |PageDn| Prev |Next  |      |      |
* |------+------+------+------+------+------|------+------+------+------+------+------|
* |      |      |      |      |      |      |      |Mute  |Del   |      |      |      |
...
*/
    ...
    [_RAISE] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, KC_PGUP, KC_VOLU, KC_VOLD, KC_MPLY, _______,
        _______, _______, _______, _______, _______, _______, _______, KC_PGDOWN, KC_MPRV, KC_MNXT, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, KC_MUTE, KC_DEL, _______, _______, _______,
